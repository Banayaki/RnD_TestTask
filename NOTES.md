...
2. Коэффициент усталости используется негативный (0.7) поскольку 1 неуспешное взаимодействие из 5 произошло в рассматриваемом временном окне (`h-04390` `2026.09.05`)
